...
{
    public partial class Form14dmdpm : Form
    {
        public int a;
        public int b;
        public int c;
        ...
        private void showErrors()
        {
            ...
            if (textBox2ab.Text.Length > 0 && Int32.Parse(textBox2ab.Text) != (c))
            {
                labeleror4.Text = "Your answer is wrong, the correct answer is " + (c);
        ...
        private void Form14dmdpm_Load(object sender, EventArgs e)
        {
            timer1.Enabled = true;
            timer1.Stop();
        }
